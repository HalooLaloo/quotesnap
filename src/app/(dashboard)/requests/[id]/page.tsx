        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {request.photos && request.photos.length > 0 && (
            <div className="card">
              ...
              <PhotoLightbox photos={request.photos} />
            </div>
          )}
        </div>
            ...
            <div className="space-y-3">
              {request.client_email && (
                <div className="flex items-center gap-3">
                  ...
                  <a href={`mailto:${request.client_email}`} className="text-blue-400 hover:text-blue-300 break-all">
                    {request.client_email}
                  </a>
                </div>
              )}
              ...
              {request.address && (
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 shrink-0 text-slate-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
