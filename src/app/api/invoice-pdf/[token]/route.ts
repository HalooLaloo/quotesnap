...
export async function GET(
  ...
  try {
    ...
    // Thank you message — position after content, or at bottom of page
    y += 15
    if (y > 260) {
      doc.addPage()
      y = 20
    }
    const thankYouY = Math.max(y, 260)
    ...
    doc.text('Invoice generated by BrickQuote', 105, thankYouY + 15, { align: 'center' })
