      ...
      <section id="pricing" className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-lg mx-auto">
            <div className="relative bg-gradient-to-b from-[#162a4a] to-[#132039] border border-blue-500/30 rounded-2xl overflow-hidden">
              {/* Glow effect */}
              ...
              <div className="relative p-8 sm:p-10">
                ...
                <div className="flex justify-center mb-8">
                  <div className="flex items-center gap-2 bg-blue-500/15 border border-blue-500/25 rounded-full px-5 py-2.5">
                    <svg className="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                ...
                <div className="text-center mb-2">
                  <div className="flex items-baseline justify-center gap-1">
                    <span className="text-6xl sm:text-7xl font-extrabold text-white tracking-tight">$29</span>
                ...
                <Link
                  href="/register"
                  className="block w-full text-center bg-blue-600 hover:bg-blue-500 text-white py-4 rounded-xl font-bold text-lg transition shadow-lg shadow-blue-600/25 hover:shadow-blue-500/30 mb-4"
                >
                  Start free trial
                </Link>
            ...
            {/* Price lock & early adopter messaging */}
            <div className="mt-6 space-y-3">
              <div className="flex items-center gap-3 bg-[#132039] border border-[#1e3a5f] rounded-xl px-5 py-4">
                ...
                <div>
                  <p className="text-white text-sm font-semibold">Price locked for you</p>
                  <p className="text-slate-500 text-xs">Sign up now and keep $29/mo forever, even when we raise prices.</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-[#132039] border border-[#1e3a5f] rounded-xl px-5 py-4">
                ...
                <div>
                  <p className="text-white text-sm font-semibold">Price may increase for future users</p>
                  <p className="text-slate-500 text-xs">As we add more AI features, the price will go up. Early adopters keep the current rate.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-500/10 border border-slate-500/20">
              ...
              <span className="text-sm text-slate-400 font-medium">Secure payments via Stripe</span>
            </div>
          </div>
        </div>
      </section>
